...
<div className="w-64 bg-white dark:bg-[#0a0a0a] border-r border-gray-200 dark:border-neutral-800 flex flex-col flex-shrink-0">
{/* Header da Sidebar */}
...
<div className="w-96 bg-gray-50 dark:bg-[#0a0a0a] border-r border-gray-200 dark:border-neutral-800 flex flex-col flex-shrink-0">
{/* Header da Lista - FIXO */}
<div className="p-6 bg-white dark:bg-[#0a0a0a] border-b border-gray-200 dark:border-neutral-800 flex-shrink-0">
...
selectedEmail?.id === email.id
                      ? 'bg-blue-50 dark:bg-blue-900/10 border-blue-200 dark:border-blue-800 scale-[1.02]'
                      : 'bg-white dark:bg-[#111111] border-transparent hover:bg-gray-50 dark:hover:bg-neutral-800 hover:shadow-md'
...
<div className="flex-1 bg-gray-100 dark:bg-black flex flex-col overflow-hidden">
{selectedEmail ? (
<>
{/* Header do Email - FIXO */}
<div className="p-6 bg-white dark:bg-black border-b border-gray-200 dark:border-neutral-800 flex-shrink-0">
...
<div className="bg-white dark:bg-neutral-900 rounded-lg p-6 shadow-sm transition-all duration-200 hover:shadow-md">
<div className="whitespace-pre-line text-[var(--corporate-text-primary)] leading-relaxed">
{selectedEmail.fullContent}
</div>
{/* Seção de Análise IA */}
<div className="mt-6 p-4 bg-gray-50 dark:bg-[#0a0a0a] rounded-lg border">
...
{showAnalysis && (
<div className="mt-4 p-4 bg-blue-50 dark:bg-blue-900/10 rounded-lg border border-blue-200 dark:border-blue-800 transition-all duration-500 ease-in-out">
...
<div className="bg-white dark:bg-black rounded p-4 border">
